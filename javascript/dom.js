...
// Apliquemos el metodo map para mostrar los nombres de los usuarios
// La funcion map es una funcion de orden superior
...
const dateToCompareParsed = new Date(date)
...
console.log("Results with e", resultsWithE)

// common name - independet - flags PNG - google Maps traer con filter

const countriesWithFlagAndGoogleMapsAndName = countries.filter(
  (country) =>
...
console.log(
  "Countries with flag and google maps and name",
  countriesWithFlagAndGoogleMapsAndName
)

const countriesTransformedWithMap = countriesWithFlagAndGoogleMapsAndName.map(
  (independentCountry) => {
    const countryTransformed = {
      countryNameCommon: independentCountry.name.common,
      countryFlag: independentCountry.flags.png,
...
console.log("Countries transformed with map", countriesTransformedWithMap)

const arrayImages = [
  {
    // countryName: "Brazil", TODO: Review...
    imageURL: "https://flagcdn.com/w320/br.png?q=imagen-brazil",
  },
]

const arrayImagesTransformed = countriesTransformedWithMap.map((country) => {
  const imageTransformed = {
    countryName: country.countryNameCommon,
    imageURL: country.countryFlag,
  }
  return imageTransformed
})

console.log("Array images transformed", arrayImagesTransformed)

const arrayImagesTransformedWithSpreadOperator = [
  ...arrayImages,
  ...arrayImagesTransformed,
]

console.log(
  "Array images transformed with spread operator",
  arrayImagesTransformedWithSpreadOperator
)

const arrayImagesTransformedWithSpreadOperatorAndFilter =
  arrayImagesTransformedWithSpreadOperator.filter((image) => image.countryName)

console.log(
  "Array images transformed with spread operator and filter",
  arrayImagesTransformedWithSpreadOperatorAndFilter
)

const arrayImagesTransformedWithSpreadOperatorAndFilterAndMap =
  arrayImagesTransformedWithSpreadOperatorAndFilter.map((image) => {
    const imageTransformed = {
      countryName: image.countryName,
...
console.log(
  "Array images transformed with spread operator and filter and map",
  arrayImagesTransformedWithSpreadOperatorAndFilterAndMap
)
